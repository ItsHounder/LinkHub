...
**LinkHub** — це персональний веб-сервіс (аналог Linktree), створений для об'єднання всіх ваших важливих посилань на одній стильній сторінці. Користувачі можуть реєструватися та налаштовувати дизайн свого профілю.
...
* **Персоналізація профілю:**
    * Зміна відображуваного імені та опису (BIO).
...
![Preview](preview/link.png) ![Preview](preview/login.png)
---
